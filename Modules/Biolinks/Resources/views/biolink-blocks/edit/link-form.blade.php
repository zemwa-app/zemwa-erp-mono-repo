<x-form id="edit-block-{{ $tab->id }}" method="PUT" data-block-id="{{ $tab->id }}" class="ajax-form">
    ...
    <div class="col-sm-12">
        <x-forms.text fieldId="url-{{ $tab->id }}" :fieldLabel="__('app.url')" fieldName="url" fieldValue="{{ $tab->url }}" class="block-update"
    ...
    <div class="custom-control custom-switch ml-3 col-sm-6">
        ...
        <input type="checkbox"
               ...
               class="cursor-pointer custom-control-input change-module-setting block-update"
