<x-form id="edit-block-{{ $tab->id }}" method="PUT" data-block-id="{{ $tab->id }}" class="ajax-form">
    <input type="hidden" name="type" value="phone-collector">
    {{--  FORM SETTINGS START --}}
    ...
    <div class="col-sm-12">
        <x-forms.text fieldId="phone_placeholder" :fieldLabel="__('biolinks::app.phonePlaceholder')" fieldName="phone_placeholder" :fieldValue="$tab->placeholder"
