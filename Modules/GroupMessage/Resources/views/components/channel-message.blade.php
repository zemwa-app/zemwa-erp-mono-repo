<div class="card ticket-message rounded-0 border-0 m @if (user()->id == $user->id) bg-white-shade @endif"
        ...
        <div class="card-body border-0 pl-0">
            <div class="d-flex">
                <a
                    ...
                    <h4 class="card-title f-13 f-w-500 text-dark mr-3 mb-0">{{ $user->name }}</h4>
                </a>
            ...
            @if ($message->message != '')
                <div class="card-text text-dark-grey text-justify  text-break f-13">
