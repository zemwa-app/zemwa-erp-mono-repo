            ...
            <div class="msg-content-left border-top-0 border-bottom-0">
                <div class="msg-header d-flex align-items-center">
                    <div class="msg-header-left d-flex justify-content-between">
                        ...
                        <div class="pl-2 d-lg-none">
                            <x-forms.button-primary class="btn btn-sm" id="new-chat-mbl" icon="plus">@lang('app.new')
                ...
                <x-tab-section class="chat-tabs">
                    <div class="d-flex justify-content-around">
                        <x-tab-item class="ajax-tab" :active="request('view') === 'private' || !request('view')"
                        :link="route('group-messaging.index').'?view=private'">@lang('groupmessage::app.privateChat')</x-tab-item>
                        <x-tab-item class="ajax-tab" :active="request('view') === 'client'"
                        :link="route('group-messaging.index').'?view=client'">@lang('groupmessage::app.clientChat')</x-tab-item>
                        <x-tab-item class="ajax-tab" :active="request('view') === 'group'"
                        :link="route('group-messaging.index').'?view=group'">@lang('groupmessage::app.groupChat')</x-tab-item>
                    </div>
                </x-tab-section>
                ...
                <div data-menu-vertical="1" data-menu-scroll="1" data-menu-dropdown-timeout="500" id="msgLeft"
                    ...
                    @include('groupmessage::messages.groups.group_list')
                </div>
