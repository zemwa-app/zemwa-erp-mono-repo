						...
						<div class="col-md-12 mb-2">
							<div class="row my-2">
								<div class="col-sm-10 d-flex align-items-center">
									<p class="m-0 f-21 font-weight-normal text-capitalize"><i class="fa fa-file-alt"></i> @lang('landingpagepro::app.header.pageTitle')</p>
								</div>
								<div class="col-sm-2">
							...
							<div class="col-4">
								...
								<select class="form-control" name="package" id="package" required>
									...
									@foreach($packages as $package)
										@php
											{{ $disabled = $excludedPackageIds->contains($package->id) ? 'disabled' : ''; }}
										@endphp
			...
			$('.editLimit').on('click', function(){
				...
				$.ajax({
					...
					success: function(response){
						...
						$('#categoryLimit').val(response.category_limit);
