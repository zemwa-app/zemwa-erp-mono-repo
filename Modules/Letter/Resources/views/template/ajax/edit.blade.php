        ...
        <x-form id="editLetter">
            <div class="add-client bg-white rounded">
                    ...
                    <div class="col-md-8">
                        <div class="col-md-12">
                            <x-forms.text fieldId="title" :fieldLabel="__('app.title')" fieldName="title" fieldRequired="true"
                                fieldPlaceholder="" :fieldValue="$letter->title">
                            </x-forms.text>
                        </div>
                        ...
                        <div class="col-md-12">
                            ...
                            <div id="description" class="h-auto">{!! $letter->description !!}</div>
                ...
                <x-form-actions>
                    ...
                    <x-forms.button-primary id="save-letter" icon="check">@lang('app.update')</x-forms.button-primary>
                </x-form-actions>
            </div>
        </x-form>
