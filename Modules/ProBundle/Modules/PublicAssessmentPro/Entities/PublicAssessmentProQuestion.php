...
class PublicAssessmentProQuestion extends BaseModel
{
    ...
    protected $table = 'public_assessment_pro_questions';
    ...
    {
        return $this->belongsTo(PublicAssessmentProAssessment::class, 'assessment_id');
    }

    public function qCategory()
    {
        return $this->hasOne(PublicAssessmentProQuestCategory::class,'quest_cat_id');
    }

    public function answers()
    {
        return $this->hasMany(PublicAssessmentProAnswer::class, 'question_id', 'id');
    }
