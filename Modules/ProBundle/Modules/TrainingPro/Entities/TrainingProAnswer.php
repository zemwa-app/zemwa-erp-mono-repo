...
class TrainingProAnswer extends BaseModel
{
	protected $table = 'training_pro_answers';

	protected $guarded = ['id'];

	const MODULE_NAME = 'documentspro';
	...
	{
		return $this->belongsTo(TrainingProQuestion::class);
	}
