...
return new class extends Migration
{
    ...
    {
        if (!Schema::hasTable('public_assessment_pro_answers')) {
            Schema::create('public_assessment_pro_answers', function (Blueprint $table) {
                $table->id();
    ...
    {
        Schema::dropIfExists('public_assessment_pro_answers');
    }
};
