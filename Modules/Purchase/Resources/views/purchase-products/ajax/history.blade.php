                        ...
                        <div class="card-body border-0 p-0 ml-3">
                            ...
                            <div class="d-flex flex-grow-1">
                                <h4 class="card-title f-12 font-weight-normal text-dark mr-3 mb-1">
                                    <b>@lang('purchase::modules.product.' . $activity->label) - {{ $activity->type }}</b><br>
                                    {{ __('purchase::modules.product.' . $activity->details) }}
                                    <b>{{ mb_ucwords($activity->user->name) }}</b> <a href="{{ route('purchase-products.show', $activity->purchase_product_id) }}">View Details</a>
                                </h4>
                            </div>
