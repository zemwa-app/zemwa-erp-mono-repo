        ...
        <x-form id="save-client-note-data-form" method="PUT">
            <div class="add-client bg-white rounded">
                <h4 class="mb-0 p-20 f-21 font-weight-normal  border-bottom-grey">
                    @lang('purchase::app.vendor') @lang('app.note') @lang('app.details')</h4>

                <input type="hidden" name="vendor_id" value="{{ $vendorId }}">

                <div class="row px-4">
                    <div class="col-md-12 my-3">
                        <x-client :user="$note->vendor" />
                    </div>
                ...
                <div class="row px-4 @if ($note->note_type == 0) d-none @endif" id="private-note-details">
                ...
                <div class="row px-4">
                    <div class="col-md-12 col-lg-12">
                        <div class="form-group">
                            ...
                            <div id="details">{!! $note->note_details !!}</div>
                            <textarea name="note_details" id="details-text" class="d-none"></textarea>
                        </div>
                    </div>
                </div>
