...
class ServerManagerServiceProvider extends ServiceProvider
{
    ...
    protected function registerConfig()
    {
        ...
        $this->mergeConfigFrom(
            module_path('server-manager', 'Config/xss_ignore.php'),
            'server-manager::xss_ignore'
        );
    }
    ...
    public function registerViews()
    {
        ...
        $this->loadViewsFrom([$sourcePath], 'server-manager');
    }
    ...
    {
        $langPath = base_path('resources/lang/modules/server-manager');
