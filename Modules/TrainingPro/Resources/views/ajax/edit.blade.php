					...
					<div class="col-lg-12">
						<div class="row">
							<div class="col-sm-12 col-md-10 col-lg-10 col-xl-10">
								<input type="hidden" name="quesId" value="{{ $tpQuestion->id }}">
								...
								<x-forms.text fieldId="assesQa" :fieldLabel="__('trainingpro::app.form.assesQuestion')"
											  fieldName="assesQa" fieldValue="{{ $tpQuestion->question }}" fieldRequired="true" :fieldPlaceholder="__('trainingpro::app.form.placeholderQuestion')">
								</x-forms.text>
							</div>

							<div class="col-sm-12 col-md-2 col-lg-2 col-xl-2">
								<x-forms.number fieldId="assesMark" :fieldLabel="__('trainingpro::app.form.assesMark')"
												fieldName="assesMark" fieldValue="{{ $tpQuestion->mark }}" fieldRequired="true" :fieldPlaceholder="__('trainingpro::app.form.placeholderMark')">
								</x-forms.number>
							</div>
							...
							<div class="col-lg-6 col-md-6 col-xl-3">
								<x-forms.input-group class="d-flex align-items-end">
									<x-forms.text fieldId="assesAnsOne" :fieldLabel="__('trainingpro::app.form.assesAnswerOne')"
												  fieldName="assesAnsOne" fieldValue="{{ $tpQuestion->answers[0]->option_text }}" fieldRequired="true" :fieldPlaceholder="__('trainingpro::app.form.placeholderAnsOne')">
									</x-forms.text>
									<x-slot name="append">
							...
							<div class="col-md-6 col-lg-4 col-xl-3">
								<x-forms.input-group class="d-flex align-items-end">
									<x-forms.text fieldId="assesAnsTwo" :fieldLabel="__('trainingpro::app.form.assesAnswerTwo')"
												  fieldName="assesAnsTwo" fieldValue="{{ $tpQuestion->answers[1]->option_text }}" fieldRequired="true" :fieldPlaceholder="__('trainingpro::app.form.placeholderAnsTwo')">
									</x-forms.text>
									<x-slot name="append">
										<label class="btn btn-outline-light form-control btnRightAns" style="margin-bottom:16px; padding-top:10px; padding-bottom:11px">
							...
							<div class="col-md-6 col-lg-4 col-xl-3">
								<x-forms.input-group class="d-flex align-items-end">
									<x-forms.text fieldId="assesAnsThree" :fieldLabel="__('trainingpro::app.form.assesAnswerThree')"
												  fieldName="assesAnsThree" fieldValue="{{ $tpQuestion->answers[2]->option_text }}" :fieldPlaceholder="__('trainingpro::app.form.placeholderAnsThree')">
									</x-forms.text>
									<x-slot name="append">
										<label class="btn btn-outline-light form-control btnRightAns" style="margin-bottom:16px; padding-top:10px; padding-bottom:11px">
							...
							<div class="col-md-6 col-lg-4 col-xl-3">
								<x-forms.input-group class="d-flex align-items-end">
									<x-forms.text fieldId="assesAnsFour" :fieldLabel="__('trainingpro::app.form.assesAnswerFour')"
												  fieldName="assesAnsFour" fieldValue="{{ $tpQuestion->answers[3]->option_text }}" :fieldPlaceholder="__('trainingpro::app.form.placeholderAnsFour')">
									</x-forms.text>
									<x-slot name="append">
										<label class="btn btn-outline-light form-control btnRightAns" style="margin-bottom:16px; padding-top:10px; padding-bottom:11px">
...
<script>
	$(document).ready(function() {
		var correctAnswer = "{{ $tpQuestion->correct_answer }}";
		...
		$('#tpQsStatus').prop('checked', {{ $tpQuestion->is_enabled }} == 1);
