    ...
    <x-form id="createConversationForm">
        <div class="row">
            ...
            <div class="col-md-12" id="member-list">
                <div class="form-group">
                    <x-forms.select fieldId="selectEmployee" :fieldLabel="(($type == 'client') ? __('groupmessage::app.chooseClient') : __('modules.messages.chooseMember'))"
            ...
            <div class="col-md-12 my-5">
                ...
                <input type="hidden" name="active_tab" id="active-tab" value="{{ $type }}">
...
<script>
    ...
    $('#save-message').click(function () {
        ...
        var url = "{{ route('group-messaging.store') }}";
        $.easyAjax({
            url: url,
