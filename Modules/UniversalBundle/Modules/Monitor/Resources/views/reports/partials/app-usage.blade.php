<div class="card-header bg-white border-bottom-grey p-20">
    <h4 class="f-16 f-w-500 mb-0">@lang('monitor::app.appUsage')</h4>
</div>
        ...
        <table class="table table-hover w-100 f-14 mb-0">
            <thead>
                <tr class="text-uppercase f-11 text-lightest">
                    ...
                    <th>@lang('monitor::app.appName')</th>
            ...
            <tbody>
                @forelse ($report['rows'] as $row)
                    <tr>
                        ...
                        <td>
                            <span class="badge {{ \Modules\Monitor\Services\MonitorEmployeeDetailService::categoryBadgeClass($row['category']) }}">
                                @if ($row['category'] === 'productive')
                                    @lang('monitor::app.categoryProductive')
                                @elseif ($row['category'] === 'unproductive')
