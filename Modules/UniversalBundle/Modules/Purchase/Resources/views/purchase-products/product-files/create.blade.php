...
<div class="modal-header">
    <h5 class="modal-title" id="modelHeading">@lang('purchase::modules.product.addImages')</h5>
...
<script>
    $(document).ready(function() {
        ...
        let url = "{{ route('purchase_products.store_images') }}?product_id=" + productId;
        ...
        productDropzone.on('addedfile', function() {
