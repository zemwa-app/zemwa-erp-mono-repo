<div class="qr-placeholder">
    <svg version="1.1" id="Livello_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px"
        y="0px" viewBox="-260 40 520 520" style="enable-background:new -260 40 520 520;"
        xml:space="preserve">
        <style type="text/css">
            .st0 {
                fill: #E5E5E5;
        ...
        <g>
            <rect id="XMLID_13_" x="100" y="320" class="st0" width="40" height="40" />
            <rect id="XMLID_13_" x="55" y="400" class="st0" width="40" height="40" />
            <rect id="XMLID_12_" x="145" y="400" class="st0" width="40" height="40" />
