        ...
        <div class="add-{{ $importClassName }} bg-white rounded">
            <h4 class="mb-0 p-20 f-21 font-weight-normal  border-bottom-grey">
                ...
                <div class="col-md-12 import-table">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <label class="control-label pt-2" fieldRequired="true">
                                @lang('recruit::modules.job.selectJob')
                                <span class="required-star">*</span>
                            </label>
                            <div id="selectOptionList">
                                <select class="form-control select-picker mb-2" id="recruit_job_id" name="recruit_job_id">
                    ...
                    <div class="row">
                        @php
                            // Determine columns to iterate over - use fileHeading if available, otherwise use first row of importSample
                            $columnsToIterate = [];
                            if (!empty($fileHeading) && is_array($fileHeading)) {
                                $columnsToIterate = array_keys($fileHeading);
                            } elseif (!empty($importSample) && isset($importSample[0]) && is_array($importSample[0])) {
                                $columnsToIterate = array_keys($importSample[0]);
                            }
                        @endphp
                        @forelse ($columnsToIterate as $key)
...
<script type="text/javascript">
    ...
    $('.select-picker').selectpicker();
        ...
        let currentImportColumnID = (jsColumnArray.length > 0) ? jsColumnArray[0].id : ''; // By default column 0 is selected
