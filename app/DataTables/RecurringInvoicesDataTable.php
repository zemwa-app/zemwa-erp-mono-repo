...
class RecurringInvoicesDataTable extends BaseDataTable
{
    ...
    public function query(Invoice $model)
    {
        ...
        // Don't filter by project relationship - show all invoices for this recurring invoice
        // The project relationship is loaded with withTrashed() so it will work even if project is deleted
