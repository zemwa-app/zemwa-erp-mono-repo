...
class CustomModuleController extends AccountBaseController
{
    ...
    public function index()
    {
        ...
        $this->allModules = Module::toCollection()->filter(function ($module, $key) {
            return $key !== 'UniversalBundle' && $key !== 'ProBundle';
        });
        ...
        /** @phpstan-ignore-next-line */
        $this->proBundle = Module::find('ProBundle');
    ...
    public function store(Request $request)
    {
        ...
        if ($validateModule['status'] == true) {
            ...
            // if module is universal bundle or pro bundle module then activate the module
            if ($moduleName == 'UniversalBundle' || $moduleName == 'ProBundle') {
                /** @phpstan-ignore-next-line */
