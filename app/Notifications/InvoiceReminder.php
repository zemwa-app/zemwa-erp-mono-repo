...
class InvoiceReminder extends BaseNotification
{
    ...
    public function toMail($notifiable)
    {
        ...
        $content = __('email.invoiceReminder.text') . ' ' . $this->invoice->due_date->toFormattedDateString() . '<br>' . new HtmlString($invoice_number) . '<br>' . __('email.messages.loginForMoreDetails');
