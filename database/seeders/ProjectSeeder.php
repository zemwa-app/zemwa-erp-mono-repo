...
class ProjectSeeder extends Seeder
{
    ...
    private function createTimeLog($faker, $project, $companyId)
    {
        ...
        $timeLog->total_hours = (int)($timeLog->start_time->diffInHours($timeLog->end_time));

        if ($timeLog->total_hours == 0) {
            /** @phpstan-ignore-next-line */
            $timeLog->total_hours = (int)round($timeLog->start_time->diffInHours($timeLog->end_time), 2);
