...
return array(
    ...
    'importTaskExcelInfo' => 'Date format should be in Y-m-d (e.g. 2022-04-21) format. Priority values: high, medium, low. Status can be slug (incomplete, completed, to_do, doing) or column name. Assignees and labels should be comma-separated. Assignees use employee email addresses.',
    ...
    'suspended' => 'Suspended',
    'withFailedPayments' => 'With Failed Payments',
    'frequency' => 'Frequency',
