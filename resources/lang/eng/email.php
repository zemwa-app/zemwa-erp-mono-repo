...
return array(
    ...
    'payfastPaymentFailed' => array(
        'subject' => 'Auto-Payment Failed',
        'text' => 'We were unable to process your automatic payment. Please update your payment details or make a manual payment.',
        'action' => 'View Invoice',
    ),
    'payfastSubscriptionSuspended' => array(
        'subject' => 'Subscription Auto-Pay Suspended',
        'text' => 'A recurring subscription has been suspended after 2 consecutive failed payment attempts.',
        'failedAttempts' => 'Consecutive Failed Attempts',
