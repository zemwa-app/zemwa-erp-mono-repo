...
return array(
    ...
    'workFromTypeNotAllowed' => 'This working from option is not allowed for clock-in or clock-out',
    'autoClockInLocationNotAllowed' => 'Auto clock-in location must be one of the allowed working from options',
    'locationRequired' => 'Unable to determine your current location. Please allow location access in your browser and try again.',
    'invalidLocationCoordinates' => 'The provided location coordinates are invalid.',
    'locationPermissionDenied' => 'Location permission was denied. Please allow location access and try again.',
    'locationUnavailable' => 'Your current location could not be determined. Please try again.',
    'locationTimeout' => 'Timed out while fetching your location. Please try again.',
    ...
    'leave' => array(
        ...
        'carryForwardExpiryDateInfo' => 'Optional. Carried-forward leaves must be used by this date each leave year. Only the carry-forward balance lapses after this date; the current year allocation is unaffected. Leave blank for no expiry.',
    ...
    'subscriptionCancelText' => 'This will cancel the auto-pay subscription and clear the stored token. Are you sure?',
    'subscriptionReactivateText' => 'This will re-activate the subscription and resume auto-pay. Are you sure?',
    'subscriptionReactivateNoToken' => 'Cannot re-activate: the PayFast token was cleared when the subscription was cancelled. The client must make a new payment to set up auto-pay again.',
    'subscriptionReactivatedLocalOnly' => 'Subscription re-activated locally, but PayFast could not re-activate the token. Auto-pay may not work until the token is active on PayFast.',
);
