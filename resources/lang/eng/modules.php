...
return array(
    ...
    'timeLogs' => array(
        ...
        'addMemoAfterAutoStop' => 'Add Memo',
        'autoStoppedMemoInfo' => 'Your timer was automatically stopped at the end of your shift. Please add or update the memo for this time log.',
        'selectProject' => 'Select Project',
    ...
    'accountSettings' => array(
        ...
        'downloadsSaveHint' => 'Changes apply immediately for all users who can access this page.',
        'downloadsReadOnlyHelp' => 'You do not have permission to edit download links. Current public links are shown below.',
        ...
        'orderCustomLogoApps' => 'Order Custom Logo apps',
        'downloadsEmptyTitle' => 'No download links configured yet',
        'downloadsMobileEmpty' => 'Add Apple iOS and/or Google Android links to show app download buttons.',
        'downloadsCardIosTitle' => 'Apple iOS',
        'downloadsCardAndroidTitle' => 'Google Android',
        'downloadsUrlNotConfigured' => 'URL not configured',
        'iosAppUrl' => 'Apple App Store/TestFlight URL',
        'androidAppUrl' => 'Google Play Store URL',
        'downloadsAppStoreHint' => 'This appears to be an Apple App Store/TestFlight link.',
        'downloadsPlayStoreHint' => 'This appears to be a Google Play Store link.',
    ...
    'invoiceSettings' => array(
        ...
        'reminderSettingsSubtitle' => 'Configure global reminder settings for invoices.',
        'globalReminderSettings' => 'Global Reminder Settings',
        'globalReminderSettingsInfo' => 'These settings will apply to all invoices by default.',
        'whenToSendReminders' => 'When to Send Reminders',
        'sendReminderBeforeDueDate' => 'Send reminder before due date',
        'sendReminderAfterDueDate' => 'Send reminder after due date',
        'timeBeforeDueDate' => 'Time Before Due Date',
        'beforeDueDate' => 'before due date',
        'afterDueDate' => 'after due date',
        'addAnotherReminderBefore' => 'Add Another Reminder Before Due Date',
        'sendEvery' => 'Send',
        'every' => 'Every',
        'startAfter' => 'Start after',
        'remindersUntilPaidInfo' => 'Reminders will continue to be sent until the invoice is marked as paid.',
        'reminderSchedule' => 'Reminder Schedule',
        'sendReminderLabel' => 'Send reminder',
        'untilInvoicePaid' => 'Until invoice is paid',
        'onlyTimes' => 'Only',
        'times' => 'times',
        'forDays' => 'For',
        'customEndDate' => 'Custom end date',
        'howRemindersWork' => 'How Reminders Work',
        'howRemindersWorkInfo' => 'The system sends reminders based on your schedule until the invoice is paid or the schedule is finished.',
        'reminderSummary' => 'Reminder Summary (Global)',
        'beforeDueDateReminders' => 'Before Due Date Reminders',
        'afterDueDateReminders' => 'After Due Date Reminders',
        'until' => 'Until',
        'includePdf' => 'Include PDF',
        'includePaymentLink' => 'Include Payment Link',
        'overrideReminderInfo' => 'You can override these global settings for specific invoices from the invoice edit page.',
        'emailOptions' => 'Email Options',
        'useCustomReminder' => 'Use custom reminder settings for this invoice',
        'useCustomReminderInfo' => 'When enabled, this invoice ignores company reminder settings and uses the options below.',
        'invoiceReminderSettings' => 'Reminder Settings',
        'startingAfter' => 'starting after',
        'noBeforeRemindersConfigured' => 'No before due date reminders configured',
        'afterRemindersDisabled' => 'After due date reminders disabled',
        ...
        'reminderTypeBefore' => 'Before due date',
        'reminderTypeAfter' => 'After due date',
        'reminderTypeManual' => 'Manual',
        'systemAutomatic' => 'System (Automatic)',
        'noRemindersSentYet' => 'No reminder emails have been sent for this invoice yet.',
    ),
    'mobile' => array(
        'camera' => 'Camera',
        'gallery' => 'Gallery',
    ...
    'update' => array(
        ...
        'partnerProductsTitle' => 'Partner products',
        'partnerProductsBadge' => 'Official add-ons',
        'partnerProductsBody' => 'Order official mobile and desktop add-ons from your Froiden account.',
        'partnerProductsFooter' => 'You will be redirected to envato.froid.works to complete your purchase securely.',
        'mobileAppOrderTitle' => 'Mobile App',
        'mobileAppOrderSubtitle' => 'Android & iOS',
        'mobileAppOrderBadge' => 'Most popular',
        'mobileAppOrderBody' => 'Give your team a branded mobile app for everyday HR and project workflows on the go.',
        'mobileAppOrderFeatures' => array(
            'Attendance, tasks, leaves, and notifications',
            'Works with your existing Worksuite setup',
            'Custom logo and branding options available',
        ),
        'employeeMonitoringOrderTitle' => 'Employee Monitoring App',
        'employeeMonitoringOrderSubtitle' => 'Desktop activity tracking',
        'employeeMonitoringOrderBadge' => 'Productivity',
        'employeeMonitoringOrderBody' => 'Track desktop activity, work hours, and team productivity with the official monitoring app.',
        'employeeMonitoringOrderFeatures' => array(
            'Monitor active apps and work sessions',
            'Review productivity and time insights',
    ...
    'attendance' => array(
        ...
        'allowedWorkFrom' => 'Allowed Working From',
        'allowedWorkFromTooltip' => 'Choose which working from options employees can select when clocking in or out',
    ...
    'leaves' => array(
        ...
        'lockFromPolicyUpdates' => 'Lock from policy updates',
        'lockFromPolicyUpdatesHelp' => 'When locked, scheduled recalculation will not change this employee\'s period allocation.',
        'periodAllocation' => 'Accrued this period',
        'carryForwardBalance' => 'Carried forward balance',
        'adjustAllocation' => 'Adjust allocation',
        'manualOverride' => 'Manual override',
        'totalAllocated' => 'Total allocated',
        'monthlyAccrualHint' => 'Monthly · :count/mo',
        'yearlyAccrualHint' => 'Yearly · :count/yr',
        'unlimitedLeaveHint' => 'No quota limit',
        'carryForwardPolicy' => 'Carry forward enabled',
        'carryForwardLapsedHistory' => 'Lapsed carry forward history',
        'carryForwardLapsed' => ':amount lapsed',
        'carryForwardLapsedDetail' => ':lapsed lapsed of :total carried forward (:used used before expiry)',
        'carryForwardProcessedOn' => 'Processed on',
        'carryForwardExpiryDate' => 'Carry Forward Expires On',
        'expiringOn' => 'Expiring on :date',
        'expiredOn' => 'Expired on :date',
        'nonExpiringBalance' => 'Non-expiring balance',
        'expiredUnusedLeaves' => 'Expired unused leaves',
        'lapsedUnusedLeaves' => 'Unused leaves (lapsed)',
        'remaining' => 'Remaining',
    ...
    'lead' => array(
        ...
        'addLeadForm' => 'Add Lead Form',
        'configureFields' => 'Configure Fields',
        'formSlug' => 'Form Slug',
        'formSlugHelp' => 'Used in the public URL. Leave blank to auto-generate.',
        'submissionSettings' => 'Submission Settings',
        'submissions' => 'Submissions',
        'copyFormLink' => 'Copy Form Link',
        'linkCopied' => 'Link copied to clipboard',
        'shareDirectLink' => 'Share Direct link',
        'cannotDeleteDefaultForm' => 'The default lead form cannot be deleted.',
        'cannotDeleteLastForm' => 'At least one lead form is required.',
    ...
    'recurringInvoice' => array(
        ...
        'payfastRequired' => 'Requires PayFast to be active.',
    ...
    'deal' => array(
        ...
        'overwriteTemplateConfirm' => 'Selecting a template will overwrite the current subject and body. Continue?',
        ...
        'mergeFieldsHelp' => 'Use these placeholders in subject or body: {contact_name}, {contact_email}, {contact_company}, {deal_name}, {deal_value}, {deal_stage}, {deal_pipeline}, {agent_name}, {company_name}, {today_date}',
    ),
