        ...
        <div class="col-sm-12">
            <div class="card bg-white border-0 b-shadow-4">
                ...
                <div class="card-body">
                    ...
                    @if($bankTransaction->bankAccount->type == 'bank' && $bankTransaction->bankAccount->sort_code)
                        <x-cards.data-row :label="__('Sort Code')" :value="$bankTransaction->bankAccount->sort_code" />
                    @endif
