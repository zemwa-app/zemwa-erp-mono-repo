    ...
    <div class="col-xl-12 col-lg-12 col-md-12 mb-4 mb-xl-0 mb-lg-4 mb-md-0 mt-5">
        ...
        <x-cards.data :title="__('modules.employees.passportDetails')">
            ...
            @if($passport)
                ...
                <x-cards.data-row :label="__('modules.employees.alertBeforeMonths')" :value="$passport->alert_before_months > 0 ? $passport->alert_before_months . ' ' . ($passport->alert_before_months == 1 ? __('app.month') : __('app.monthPlural')) : __('app.noAlert')" />
                <div class="col-12 px-0 pb-3 d-block d-lg-flex d-md-flex">
                    <p class="mb-0 text-lightest f-14 w-30 d-inline-block ">
            ...
            <x-cards.data :title="__('modules.employees.visaDetails')"
                ...
                <x-table class="border-0 pb-3 admin-dash-table table-hover">
                    ...
                    <x-slot name="thead">
                        ...
                        <th>@lang('modules.employees.alertBeforeMonths')</th>
