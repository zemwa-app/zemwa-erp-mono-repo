                    ...
                    <nav class="tabs px-4 border-bottom-grey">
                        <div class="nav" id="nav-tab" role="tablist">
                            ...
                            @if (in_array('invoices', user_modules()))
                                ...
                                <a class="nav-item nav-link f-15 reminder"
                                    href="{{ route('invoice-settings.index') }}?tab=reminder" role="tab"
                                    aria-controls="nav-ticketTypes" aria-selected="true">@lang('app.menu.reminderSettings')
                                </a>
                            @endif
