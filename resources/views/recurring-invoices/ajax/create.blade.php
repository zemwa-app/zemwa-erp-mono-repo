        ...
        <div class="row px-lg-4 px-md-4 px-3 pt-3">
            ...
            <div class="col-md-8">
                <div class="row">
                    ...
                    <div class="col-md-4 mt-4 d-none" id="custom_interval_fields">
                        ...
                        <div class="form-group">
                            <div class="input-group">
                                <input type="number" min="1" class="form-control height-35 f-15" name="billing_interval"
                                       id="billing_interval" value="1">
                                <div class="input-group-append" style="min-width: 120px;">
                                    <select class="form-control select-picker" name="billing_unit" id="billing_unit">
                                        <option value="days">@lang('modules.recurringInvoice.days')</option>
                                        <option value="weeks">@lang('modules.recurringInvoice.weeks')</option>
                                        <option value="months" selected>@lang('modules.recurringInvoice.months')</option>
                                        <option value="years">@lang('modules.recurringInvoice.years')</option>
                                    </select>
                                </div>
                            </div>
                        </div>
