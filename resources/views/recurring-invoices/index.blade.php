...
@php
    ...
    $viewInvoicesPermission = user()->permission('view_invoices');
        ...
        <div class="d-block d-lg-flex d-md-flex justify-content-between">
            <div id="table-actions" class="flex-grow-1 align-items-center mb-2 mb-lg-0 mb-md-0">
                @if ($addInvoicesPermission == 'all' || $addInvoicesPermission == 'added')
                    <x-forms.link-primary :link="route('recurring-invoices.create')" class="mr-3 float-left mb-2 mb-lg-0 mb-md-0" icon="plus">
            ...
            <div class="btn-group mt-3 mt-lg-0 mt-md-0 ml-lg-3" role="group">
                @if (isset($paymentGateway) && $paymentGateway->payfast_status === 'active')
                    @if ($addInvoicesPermission == 'all' || $manageRecurringInvoicesPermission == 'all' || in_array($viewInvoicesPermission, ['all', 'added']))
                        <a href="{{ route('subscriptions.index') }}" class="btn btn-secondary f-14 mr-2"
                           data-toggle="tooltip" data-original-title="@lang('app.subscriptions')">
                            <i class="bi bi-credit-card-2-front f-16"></i>
                        </a>
                    @elseif (in_array('client', user_roles()))
                        <a href="{{ route('client.subscriptions.index') }}" class="btn btn-secondary f-14 mr-2"
                           data-toggle="tooltip" data-original-title="@lang('app.mySubscriptions')">
                            <i class="bi bi-credit-card-2-front f-16"></i>
                        </a>
                    @endif
                @endif
