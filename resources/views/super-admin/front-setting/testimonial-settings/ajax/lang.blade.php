<div class="col-xl-12 col-lg-12 col-md-12 ntfcn-tab-content-left w-100 p-20">
    ...
    <div class="row">
        <div class="col-md-12">
            <x-forms.text :fieldLabel="__('app.title').$lang->label" fieldName="title" :fieldValue="$trFrontDetail ? $trFrontDetail->testimonial_title : ''" autocomplete="off" fieldId="title" />
        </div>
    </div>
</div>
<!-- Buttons Start -->
