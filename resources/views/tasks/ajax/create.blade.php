            ...
            <div class="add-client bg-white rounded">
                ...
                <div class="row p-20">
                    ...
                    @if (in_array('projects',user_modules()))
                        ...
                        @php
                            $projectRequired = (in_array('client', user_roles()) || ($taskSetting->project_required ?? 'no') == 'yes') ? 'true' : 'false';
                        @endphp
    ...
    {{--                            ></x-forms.select2-ajax>--}}
                            @else
                                <x-forms.select fieldId="project_id" fieldName="project_id" :fieldLabel="__('app.project')"
                                                ...
                                                search="true" :fieldRequired="$projectRequired">
                                    <option value="">--</option>
