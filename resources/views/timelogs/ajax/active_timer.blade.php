                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            ...
                            <p class="text-primary my-2">
                                @php
                                    $totalMinutes = abs((int) (now()->diffInMinutes($myActiveTimer->start_time) - $myActiveTimer->breaks->sum('total_minutes')));
                                @endphp
                                    ...
                                    <li class="list-group-item d-flex justify-content-between align-items-center f-12 text-dark-grey">
                                        @if (!is_null($item->end_time))
                                            ...
                                            <span><i class="fa fa-mug-hot"></i> @lang('modules.timeLogs.break')
                                                {{\Carbon\CarbonInterval::formatHuman(abs((int) $item->end_time->diffInMinutes($item->start_time)))}}
                                            </span>
                                ...
                                <div class="mt-1 f-12">
                                    @if (is_null($item->activeBreak))
                                        <span class="badge badge-secondary">
                                            ...
                                            {{\Carbon\CarbonInterval::formatHuman(abs((int) (now()->diffInMinutes($item->start_time) - $item->breaks->sum('total_minutes'))))}}
                                        </span>
                                    @else
