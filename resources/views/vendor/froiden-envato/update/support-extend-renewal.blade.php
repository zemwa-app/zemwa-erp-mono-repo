                ...
                <div class="col-md-12 mt-3">
                    ...
                    @if($expired)
                        ...
                        <x-forms.link-secondary class="mr-2 e-btn--3d -color-primary -size-m -width-full h-mt"
                                                link="https://froiden.freshdesk.com/support/tickets/new"
                                                target="_blank"
                                                data-toggle="tooltip"
                        ...
                        <x-forms.link-secondary class="mr-2 e-btn--3d -color-primary -size-m -width-full h-mt"
                                                link="https://bit.ly/worksuite-amc-offer"
                                                target="_blank"
                                                data-toggle="tooltip"
                                                data-original-title="Tired of long waits for ticket resolutions? Save 50% and get lots of features with our amc plans"
