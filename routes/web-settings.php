...
use App\Http\Controllers\DealEmailTemplateController;
...
Route::group(['middleware' => 'auth', 'prefix' => 'account/settings'], function () {
    ...
    Route::post('invoice-settings/update-reminder-setting/{id}', [InvoiceSettingController::class, 'updateReminderSetting'])->name('invoice_settings.update_reminder_setting');
    ...
    Route::get('deal-email-templates/fetch', [DealEmailTemplateController::class, 'fetchTemplate'])->name('deal-email-templates.fetch');
    Route::resource('deal-email-templates', DealEmailTemplateController::class)->except(['show']);
